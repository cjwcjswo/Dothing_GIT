							...
							<div class="wrapper">
								...
								<div class="answer">
									...
									<p>안전심부름꾼은 신원이 확인된 사람이라면 누구나 안전 심부름꾼으로 일할 수 있으며, 자신이 원하는
										시간과 장소에서 원하는 일만 택하여 일할 수 있습니다. 고객을 도와드리며 보람도 느끼고 추가적으로 수익이 생길
										수 있는 직업! DoThing에 가입하시고 안전 심부름꾼으로 인증 받아보세요~</p>
							...
							<div class="wrapper">
								...
								<div class="answer">
									...
									<p>DoThing와 고객 간의 상호 평가와 신고를 관리자와의 문의를 통해 문제가 있는 회원들은 서비스
										이용에 제한을 받게됩니다. 고객은 심부름 댓글 신청들 중 최종 선택을 하기에 DoThing의 수행이력, 평점,
										금액 등을 고려해서 더 믿을 만한 심부름꾼에게 요청해주시면 됩니다.</p>
								</div>
							</div>
						</article>
						<!-- /.faq-single-->
						...
						<article class="faq-single">
							...
							<div class="wrapper">
								...
								<div class="answer">
									...
									<p>심부름 완료를 하지 않으면 음식을 받을 수 없다. 먼저 계산된 포인트는 심부름꾼에게 지불하게 됩니다.</p>
								</div>
							</div>
						</article>
						<!-- /.faq-single-->
