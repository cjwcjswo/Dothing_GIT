	...
	<div id="page-canvas">
			...
			<div class="breadcrumb-wrapper">
				<div class="container">
					...
					<ol class="breadcrumb">
						...
						<li><a
							href="${pageContext.request.contextPath}/board/noticeBoardList">공지
								게시판</a></li>
		...
		<div id="page-content">
			<div class="container">
				...
				<form name="writeForm"
					action="${pageContext.request.contextPath}/board/noticeInsert"
					...
					<div class="form-group">
						<label for="faq-form-email">제목</label> <input type="text"
							class="form-control" name="noticeTitle" id="faq-form-email"
							required="">
					</div>
					<!-- /.form-group -->
					<div class="form-group">
						...
						<textarea class="form-control" id="faq-form-question" rows="5"
							required="" name="noticeContent"></textarea>
					</div>
					<!-- /.form-group -->
					<div class="form-group">
						<span align="left"><a
