...
public interface ErrandsDAO {
	 ...
	 * @param responseId 추가 할 심부름 배달꾼 id
	 * @param startTime 심부름 시작 시간 추가
	 * @param arrivalTime 심부름꾼 도착 시간 추가
	 * @param finishTime 요청자가 배달받은 시간 추가
	 * @return 성공 여부
	 * */
	 ...
	 * @param num 해당하는 심부름 번호
	 * @return 심부름 댓글 DTO 리스트
	 */
	 ...
	 * @return 성공여부(삭제된 심부름의 갯수)
	 */
	int deleteTimeErrands();
	
	/**
	 * 심부름에 해쉬태그 삽입하기
	 * @param hashtag 해쉬태그 값
	 * @return 성공 여부
	 */
