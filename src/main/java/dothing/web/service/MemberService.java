...
public interface MemberService {
	...
	/**
	 * 회원 가입하기
	 * @param MemberDTO member: 회원가입하고자 하는 유저정보dto
	 * @param boolean isAPI: true = Facebook API 사용해서 가입, false = 일반 가입
	 * @return int: 성공 여부
	 */
	 ...
	 * @return String: 사용 가능한지 가능하지 않은지 String 값
	 */
	 ...
	 * @param MemberDTO original: 수정하기 전 기존 유저 정보 dto
	 * @return int: 성공 여부
	 */
	...
	List<GPADTO> averageGPA(String id);
	 ...
	 /**
	  * 해당하는 유저에게 인증 메일 보내기
	  * @param String email: 해당하는 유저 이메일
	  * @param Integer authNum: 인증 번호
	  */
